...
유튜브, 트위치 등의 플랫폼에 라이브 방송을 도와주는 안드로이드 앱 개발을 담당하고 있다가 최근 웹 프론트 개발과 서버 개발이 필요한 상황이 되어 react를 이용하여 웹 프론트개발과 nestjs를 이용하여 api 서버 개발에도 관여하고있습니다.
새로운 기술과 이유가 있는 기술 선택, 깔끔한 코드(유지보수가 잘되고 다른 개발자들이 이해하기 쉬운 코드), 메모리 관리, 빌드 자동화 등에 관심이 많습니다.
감사합니다.
